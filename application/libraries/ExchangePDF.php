<?php
class ExchangePDF extends TCPDF {
    var $headerHtml;
    var $footerHtml;
    ...
    public function Header() {
            ...
            $this->MultiCell(160, 5, 'National Herbarium of Victoria', 0, 'L', 0, 1, 25, 15, true, false, true);
                $this->MultiCell(160, 5, '<b>MEL '. $this->headerHtml['ExchangeType'] . ' to ' . $this->headerHtml['ExchangeTo'] .
                    ' (MEL ref. '. $this->headerHtml['ExchangeNumber'] . ')</b>', 0, 'L', 0, 1, 25, $this->GetY()-1, true, false, true);
            if ($this->PageNo()%2 != 0) {

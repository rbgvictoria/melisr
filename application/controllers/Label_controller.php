...
class Label_controller extends CI_Controller {
    ...
    function label() {
        $this->load->model('Recordset_model', 'recordsetmodel');
        $this->load->model('Label_data_model', 'labeldatamodel');
    ...
    function printLabelNew($labeldata, $props, $start=0) {
        ...
        if (!$dup)
            ...
            $labelheader='<p style="font-weight: bold"><span style="font-size: 10.5px;">Ex NATIONAL HERBARIUM OF VICTORIA (MEL)</span><br />
                <span style="font-size: 11pt;">MELBOURNE, AUSTRALIA</span></p>';
        $barcodestyle = array(
            'position' => '',
            'padding' => 0,
